...
only if that column has at least one empty location.
\hyperref[fig:c4-game]{Figure~\ref*{fig:c4-game}} shows three Connect 4 game positions. 
...
\begin{figure}[!h]
    ...
    \subfloat[Win for \textsc{Player 1}]{
        \label{fig:c4-game-1}
        \includegraphics[width=0.2\textwidth]{figures/c4/c4-win-blue-c5f2.pdf}
    } \hspace{0.1in}
    \subfloat[Win for \textsc{Player 2}]{
        \label{fig:c4-game-2}
        \includegraphics[width=0.2\textwidth]{figures/c4/c4-win-blue-c5f2.pdf}
...
However, as part of the testing phase, we will use the \emph{Connect 4 Data Set}\footnote{\URLUCI{}}
that is available from the UCI Machine Learning Repository~\citep{Hettich1998UCI}. This dataset has
a total of 67,557 instances, representing all legal 8-ply positions in \mbox{Connect 4} in which
